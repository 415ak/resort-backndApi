...
namespace ResortApiV2.Migrations
{
    ...
    [Migration("20230525185026_keyAccmd")]
    partial class keyAccmd
    {
            ...
            modelBuilder.Entity("ResortApi.Models.AccommodationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTime = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4943),
                            IsUsed = 1,
                            Name = "บ้านเดี่ยว"
                        },
                        new
                        {
                            ...
                            DateTime = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4945),
                            IsUsed = 1,
                            Name = "บ้าน2ชั้น"
                        },
                        new
                        {
                            ...
                            DateTime = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4946),
                            IsUsed = 1,
                            Name = "อาคารตึก"
                        },
                        new
                        {
                            ...
                            DateTime = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4948),
                            IsUsed = 1,
                            Name = "บ้านแพ"
                        },
                        new
                        {
                            ...
                            DateTime = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4949),
                            IsUsed = 1,
                            Name = "พื้นที่กางเต็น"
                        },
                        new
                        {
                            ...
                            DateTime = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4951),
                            IsUsed = 1,
                            Name = "อื่นๆ"
                        });
                });
            ...
            modelBuilder.Entity("ResortApi.Models.FdCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FdCategoryId = "1",
                            DateTime = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4903),
                            IsUsed = 1,
                            Name = "แกง-ต้ม"
                        },
                        new
                        {
                            FdCategoryId = "2",
                            DateTime = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4905),
                            IsUsed = 1,
                            Name = "ของทอด-ผัด"
                        },
                        new
                        {
                            FdCategoryId = "3",
                            DateTime = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4906),
                            IsUsed = 1,
                            Name = "ยำ-สลัด"
                        },
                        new
                        {
                            FdCategoryId = "4",
                            DateTime = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4907),
                            IsUsed = 1,
                            Name = "ของหวาน"
                        },
                        new
                        {
                            FdCategoryId = "5",
                            DateTime = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4908),
                            IsUsed = 1,
                            Name = "เครื่องดื่ม"
                        },
                        new
                        {
                            FdCategoryId = "6",
                            DateTime = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4910),
                            IsUsed = 1,
                            Name = "อื่นๆ"
                        });
                });
            ...
            modelBuilder.Entity("ResortApi.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = "1",
                            CreateData = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4678),
                            RoleIsused = "1",
                            RoleName = "User"
                        },
                        new
                        {
                            RoleId = "2",
                            CreateData = new DateTime(2023, 5, 26, 1, 50, 26, 404, DateTimeKind.Local).AddTicks(4697),
                            RoleIsused = "1",
                            RoleName = "Admin"
                        });
                });
