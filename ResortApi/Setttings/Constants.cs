...
namespace ResortApi.Settings
{
    public class Constants
    {
        ...
        //static public string PathServer = "http://10.103.0.16/cs63/s15/resort/backend2/images/";
        //static public string PathServer = "http://10.103.0.30/cs63/s15/resort/backend2/images/";
        ...
        static public object Return200Id(string message, string id) => new { statusCode = 200, message, id };
        static public object Return200CountData(string message, int count, object data) => new { statusCode = 200, message, count, data };
        ...
        //static public Account Return200TokenAccount(string message, string token) => new { statusCode = 200, message, token };

        //static public object Return200Token(string message, object result, string token) => new { statusCode = 200, message, result, token };
